...
Við fáum sem sagt að p-gildi slembivalsstærðarinnar er ekki ýkja ólík niðrustöðunni úr e-lið en þar fékkst p-gildið $p = 0.672$ úr t-prófinu. Líkt og í e-lið þá höfnum við ekki $H_{0}$ þar sem p-gildið er hærra en $\alpha = 0.05$. Það er því ekki marktækur munur á meðallengd fiska á hafsvæðunum tveimur. 
...
Línulega aðhvarfsgreiningarlíkanið er því $ln(w) = 3.0199ln(l) - 4.7949$. Þá fáum við að skýringarhlutfallið er $R^2 = 0.983$ svo ætla má að samband frum- og fylgibreytu sé næstum línulegt og líkanið gefi traustverðuga spá um þyngd út frá lengd. Þá getum við sagt að samband milli lengdar og þyngdar fiskanna er $w=e^{-4.7949}}\cdot l^{3.0199}$.
