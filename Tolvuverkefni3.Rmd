...
ggplot(ah_long, aes(le)) +
  ...
  labs(title = "Mynd 2: Fjögur stuðlarit af lengd fiska fyrir hvert hafsvæði.") +
...
ggplot(data = fiskar2,aes(x = factor(aldur), y = le)) +
  geom_boxplot() +
  labs(
    tiltle="Kassarit sem sýnir lengd á móti aldri fyrir hafsvæðið NAu",
    x = "Aldur",
    y = "Lengd"
  )
```
