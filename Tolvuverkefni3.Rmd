...
Bætum síðan inn tilkynningarskyldureitunum frá okkar hafssvæði:
...
kort +
  geom_label(aes(x=xNV, y=yNV, label=as.character(reitirNV)), size=2, fill="green") +
  geom_label(aes(x=xNAu, y=yNAu, label=as.character(reitirNAu)), size=2, fill="pink")
```
